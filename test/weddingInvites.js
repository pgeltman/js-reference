...
describe('Wedding Invites', () => {
  it('Blank name', () => {
    const name = nameID('');
    name.main.title.should.equal('[title]');
    name.main.firstName.should.equal('[first]');
    name.main.lastName.should.equal('[last]');
    name.partner.title.should.equal('[title]');
    name.partner.firstName.should.equal('[first]');
    name.partner.lastName.should.equal('[last]');
